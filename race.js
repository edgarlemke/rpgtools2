...
new Race("Tree",         "Plants invented animals to spread seeds.", new Stats(2, 1, 1, 1, 0), true)
new Race("Ghoul",        "Eats things.", new Stats(2, 1, 1, 1, 0), false)
new Race("Cheeseperson", "Person made of cheese.", new Stats(2, 1, 1, 1, 0), false)
new Race("Golem",        "Servant.", new Stats(2, 1, 1, 1, 0), false)
new Race("Undead",        "It can be a ghost, a skeleton or a mummy.", new Stats(2, 1, 1, 1, 0), false)
