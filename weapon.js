...
new Weapon(new Item("Bow", " ", null, 1, true, true, {Wood: 4, Material: 2}, null, 1, null, null), ["Dextrity", "Agility"], 5, ["Shooting"], "Arrow")
new Weapon(new Item("Crossbow", " ", null, 1, true, true, {Wood: 2, Material: 3, Metal: 2}, null, 1, null, null), ["Dextrity"], 5, ["Shooting"], "Dart")
new Weapon(new Item("Revolver", " ", null, 1, true, true, {Wood: 1, Material: 2, Metal: 4}, null, 1, null, null), ["Dextrity", "Agility"], 5, ["Shooting"], "Revolver ammo")
...
new Weapon(new Item("Scimitar", " ", null, 1, true, true, {Wood: 1, Material: 1, Metal: 4}, null, 1, null, null), ["Dextrity", "Agility"], 5, ["Cutting"], null)
new Weapon(new Item("Rapier", " ", null, 1, true, true, {Wood: 1, Material: 1, Metal: 4}, null, 1, null, null), ["Dextrity", "Agility"], 5, ["Perfuration"], null)

// new Weapon(new Item("Spear", " ", null, 1, true, true, {Wood: 4, Material: 1, Metal: 2}, null, 1, null, null), ["Cutting", "Perfuration", "Throwing"])
new Weapon(new Item("Light War Axe", " ", null, 1, true, true, {Wood: 2, Material: 1, Metal: 5}, null, 1, null, null), ["Strength", "Dextrity"], 5, ["Impact", "Cutting"], null)

// new Weapon(new Item("Stick", " ", null, 1, true, true, {Wood: 5, Material: 1, Metal: 0}, null, 1, null, null), ["Impact"])
new Weapon(new Item("Light War Hammer", " ", null, 1, true, true, {Wood: 2, Material: 1, Metal: 4}, null, 1, null, null), ["Strength"], 5, ["Impact"], null)
...
new Weapon(new Item("Grimorium", " ", null, 1, true, true, {Wood: 0, Material: 3, Metal: 3}, null, 1, null, null), ["Intelligence", "Charisma"], 5, ["Invocation"], null)

new Weapon(new Item("Instrument", " ", null, 1, true, true, {Wood: 1, Material: 1, Metal: 4}, null, 1, null, null), ["Charisma"], 5, ["Illusion"], null)
new Weapon(new Item("Sinister Deck", " ", null, 1, true, true, {Wood: 1, Material: 1, Metal: 4}, null, 1, null, null), ["Charisma", "Dextrity"], 5, ["Illusion", "Cutting"], null)

//new Weapon(new Item("Cheesegun", " ", 1, 5, true, true, {Wood: , Material: , Metal: }, null, 1, null, null), ["Cheese"])

new Weapon(new Item("Light Kwink", " ", null, 1, true, true, {Wood: 0, Material: 3, Metal: 3}, null, 1, null, null), ["Dextrity"], 5, [], null)

new Weapon(new Item("Ghoul Strength Damage Kit", " ", null, 1, true, true, {Wood: 0, Material: 3, Metal: 3}, null, 1, ["Ghoul"], null), ["Strength", "Dextrity"], 5, ["Impact", "Cutting"], null)
new Weapon(new Item("Ghoul Agility Damage Kit", " ", null, 1, true, true, {Wood: 0, Material: 3, Metal: 3}, null, 1, ["Ghoul"], null), ["Dextrity", "Agility"], 5, ["Cutting", "Perfuration"], null)

new Weapon(new Item("Dynamite", "Drops the item when attacks with it.", null, 1, true, true, {Wood: 4, Material: 2}, null, 1, null, null), ["Dextrity"], 5, ["Explosion"], null)
new Weapon(new Item("Granade", "The boomerang comes back to the attacker. Drops the item when attacks with it.", null, 1, true, true, {Material: 2, Metal: 1}, null, 1, null, null), ["Dextrity"], 5, ["Explosion"], null)

new Weapon(new Item("Bola", "Drops the item when attacks with it.", null, 1, true, true, {Wood: 4, Material: 2}, null, 1, null, null), ["Dextrity"], 5, ["Throwing"], null)
new Weapon(new Item("Boomerang", "The boomerang comes back to the attacker", null, 1, true, true, {Wood: 4, Material: 2}, null, 1, null, null), ["Dextrity"], 5, ["Throwing"], null)
