class Weapon {
	...
	constructor (item_obj, habilities, damage_types, ammo) {
...
new Weapon(new Item("Light Kwink", " ", null, 1, true, true, {Wood: 0, Material: 3, Metal: 3}, null, 1, null, null), ["Dextrity"], [], null)

new Weapon(new Item("Ghoul Strength Damage Kit", " ", null, 1, true, true, {Wood: 0, Material: 3, Metal: 3}, null, 1, ["Ghoul"], null), ["Strength", "Dextrity"], ["Impact", "Cutting"], null)
new Weapon(new Item("Ghoul Agility Damage Kit", " ", null, 1, true, true, {Wood: 0, Material: 3, Metal: 3}, null, 1, ["Ghoul"], null), ["Dextrity", "Agility"], ["Cutting", "Perfuration"], null)
